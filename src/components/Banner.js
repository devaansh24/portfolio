  ...
  return (
    <section className="flex  justify center sm:max-w-full sm:justify-center lg:max-w-full md:justify-center md:max-w-full lg:justify-center bg-gradient-to-r from-slate-200 to-blue-200 ">
      ...
      >
        ...
        <motion.h1
          className="font-mono text-3xl md:text-4xl py-2 text-blue-600 font-bold "
          variants={textVariants}
        >
          DEVANSH SHARMA.
        </motion.h1>
        ...
        <motion.p
          ...
          variants={textVariants}
        >
          I am a software developer."Driven by curiosity,powered by code, dedicated to delivering excellence."
        </motion.p>
